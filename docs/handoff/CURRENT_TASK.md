...
Governing documents:
- tickets/GOV-002.md
- docs/reviews/REVIEW-0120_GOV-002_CHANGES_REQUIRED.md
- docs/reviews/REVIEW-0119_GOV-002_STATUS_RECONCILIATION_AUTHORIZED.md
- docs/reviews/GOV-002_STATUS_RECONCILIATION_REPORT.md
...
GOV-002 returned to AWAITING_REVIEW after reconciliation; Reviewer is next actor;
Next ticket authorized remains NONE. Stop.
