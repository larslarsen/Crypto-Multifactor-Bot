...
Authorized scope: Complete the Jr-only integration-test remediation in REVIEW-0022. Jr Dev - Hermes may edit focused tests and BIN-001 records, run acceptance gates, and own Git/commit/push. Production source changes and Sr Dev work are not authorized unless the required real publication regression exposes a source defect and the reviewer routes it. No migration, architecture, or unrelated product changes.
