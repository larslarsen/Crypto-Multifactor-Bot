...
- [`AUD-004`](tickets/AUD-004.md) — Native headerless support for Binance archive precision comparator (`AWAITING_REVIEW`; sprint003 runner blocked by production-source serialization defect).
