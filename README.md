...
- [`AUD-004`](tickets/AUD-004.md) — Native headerless support for Binance archive precision comparator (`IN_PROGRESS`; source correction assigned to Sr Dev - Sandbox).
