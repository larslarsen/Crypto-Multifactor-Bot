...
- [`AUD-004`](tickets/AUD-004.md) — Native headerless support for Binance archive precision comparator (`IN_PROGRESS`; Sr runner-source correction owner). Next actor: Sr Dev - Sandbox.
