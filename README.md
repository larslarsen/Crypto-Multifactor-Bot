...
- [`EXP-001`](tickets/EXP-001.md) — Experiment Bundles & Fingerprints (`ACCEPTED - REVIEW-0148`; integrated at 2c230e0).
- [`UNIVERSE-001`](tickets/UNIVERSE-001.md) — CoinGecko Survivorship-Free Universe Provider (`IN_PROGRESS`; Sr Dev next).
...
- [`DF-07`](tickets/DF-07.md) — Point-in-Time On-Chain Observation Authority Audit (`ACCEPTED - NO_POINT_IN_TIME_ON_CHAIN_OBSERVATION_AUTHORITY`; REVIEW-0135/0136/0137).
