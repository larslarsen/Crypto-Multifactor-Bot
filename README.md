...
- [`DF-07`](tickets/DF-07.md) — Point-in-Time On-Chain Observation Authority Audit (`AWAITING_REVIEW`; NO_POINT_IN_TIME_ON_CHAIN_OBSERVATION_AUTHORITY, REVIEW-0135/0136).
