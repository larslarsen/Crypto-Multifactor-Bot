...
- [`BYB-001`](tickets/BYB-001.md) — Bybit public trade-archive normalizer (`AWAITING_REVIEW`; source approved under `docs/reviews/REVIEW-0048_BYB-001_SOURCE_APPROVED_JR_AUTHORIZED.md`, Jr integration complete).
